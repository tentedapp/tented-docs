...
- **An approved tent template** in Tented, to create pages. Pages are generated from a template's approved version. You can connect your store and sync customers before you have one; see [Templates](/working-with-tents/tent-templates) when you're ready.
...
You install Tented from the Shopify App Store, and Shopify brings you back to Tented to finish setup.

1. In Tented, open **Settings → Integrations**.
2. On the **Shopify** tile, select **Connect**, then **Install from the Shopify App Store**.
3. In Shopify, select **Install**, review the access Tented asks for, and approve it.
4. Shopify sends you back to Tented. Sign in (or create your Tented account) if you aren't already, and the Shopify setup opens with your store connected.

<img src="/images/shopify-integrations-tile.png" alt="The Shopify tile on the Integrations page, before connecting." width="376" />

You can also start in Shopify: find **Tented** in the Shopify App Store and install it. If Tented is already installed, open it from **Apps** in your Shopify admin to finish connecting.
...
- **Tented template**: the approved template each page starts from. Tented picks your most recently approved template; change it if you like. No approved template yet? Connect anyway to sync customers, and choose a template and a segment in **Edit settings** later.
...
<img src="/images/shopify-segment-picker.png" alt="The segment picker, listing each Shopify segment with its number of customers." width="495" />
...
<img src="/images/shopify-connect-pages.png" alt="The Pages step: the template, the chosen segment, and the metafields Tented saves to each customer." width="516" />
...
<img src="/images/shopify-connect-advanced.png" alt="The Advanced section with the page generation prompt, the link sentence, and the follow-up sentence." width="514" />
...
<img src="/images/shopify-contacts-step.png" alt="The Contacts step: the three sync options and the note on email and SMS consent." width="672" />
...
<img src="/images/shopify-contacts-fields.png" alt="Shopify fields added to the sync, the duplicates choice, and the segment the sync is limited to." width="644" />
...
<img src="/images/shopify-customer-metafields.png" alt="A customer in Shopify with the five Tented metafields filled in." width="638" />
...
<img src="/images/shopify-card-connected.png" alt="The Shopify tile once connected: store, segment, contact sync status, and last sync." width="376" />
...
- **Customer erasure.** When you erase a customer's personal data in Shopify, Tented deletes that customer's page. A contact the sync created in Tented is deleted; a contact that already existed in Tented is kept, but loses its link to Shopify and its Shopify field values, and two-way sync never adds it back to your store.
...
| **The Shopify window closed before finishing** | While reconnecting, the Shopify window was closed before you approved access | Select **Reconnect Shopify** again |
...
| The Shopify setup didn't open after installing | Signing in took a while, or you signed in to a different workspace | In Shopify, open Tented from **Apps**; Shopify sends you back to finish connecting |
| **Automatically create pages for** can't be changed | There's no approved template yet | Create and approve a template, then pick it in **Edit settings** |
