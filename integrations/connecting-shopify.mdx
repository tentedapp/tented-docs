...
<img src="/images/shopify-connect-step.png" alt="The Connect Shopify dialog with the store address filled in." width="516" />

Not sure of your store address? Shopify lists it under **Settings → Domains**. It's the one ending in `.myshopify.com`:

<img src="/images/shopify-domains.png" alt="Shopify's Settings → Domains page, showing the store's myshopify.com address." width="728" />
