...
![Instantly's Settings → Integrations → API Keys tab with a Tented key.](../images/instantly-api-keys.png)
...
![The Integrations page with the Instantly tile and its Connect button.](../images/instantly-integrations-page.png)
3. Paste your Instantly API key and select **Continue**. Tented checks the key with Instantly before moving on.

![The Connect Instantly dialog asking for an API key.](../images/instantly-connect-key.png)

## Step 2: Choose what to generate

Pick the campaign or agent to work from and the template to build pages with.

![The Choose what to generate step with a campaign and a template selected.](../images/instantly-connect-pages.png)
...
![The Advanced section with the generation prompt, link sentence, and follow-up sentence.](../images/instantly-connect-advanced.png)
...
![The live sync step confirming Live sync is on.](../images/instantly-live-sync-on.png)
...
![Instantly's campaign editor with {{tented_page_offer}} on its own line in the first email.](../images/instantly-campaign-editor.png)
...
![The Instantly tile after connecting, showing the campaign and last sync.](../images/instantly-card-connected.png)
...
![The Instantly activity dialog listing recent syncs.](../images/instantly-activity.png)
...
![The Tents list with Instantly Integration as the creator.](../images/instantly-tents-list.png)
