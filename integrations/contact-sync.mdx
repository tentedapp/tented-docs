...
| **Two-way** | Changes flow both ways: the app's edits come in, and Tented edits and new Tented contacts go back. |

## Which fields sync

**Standard fields** (name, email, company, and so on) are matched to Tented's fields for you. For each, choose what happens when a Tented contact already has a value: **Overwrite** or **Do Nothing**, the same choice a list import offers. Email and phone are match keys and are never overwritten.
