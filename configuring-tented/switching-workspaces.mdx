...
You don't need to sign out to move to another workspace:

1. Click your **profile icon** in the bottom-left corner of the sidebar.
2. Select **Switch Workspace** from the menu.
...
<Note>
  Only workspaces your email address already belongs to appear in the list. If a workspace is missing, ask an admin of that workspace to [invite you](/configuring-tented/inviting-new-users); once you're invited it shows up automatically.
</Note>
