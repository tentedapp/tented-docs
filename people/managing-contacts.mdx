...
<Note>
  Next to the total count you'll see a small **capacity ring** that fills as your database grows toward your plan's People allowance (1,000 contacts on Free; higher on Pro and Max tiers). Hover it for the exact percentage. The ring turns **yellow** from 90% and **red** once you're over the allowance — going over doesn't block imports or form submissions, but on the Free plan it does pause email blasts, and workspace admins are notified by email.
</Note>
