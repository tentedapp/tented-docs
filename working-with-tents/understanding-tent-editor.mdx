...
This area shows a real-time preview of your tent. This means you can see changes instantly as you make them, giving immediate visual feedback. Interactive elements like links, anchors, menus, and animations work in this preview window. Form submissions are the one exception: they are disabled in the preview, so publish the tent and use your live page to test a real submission.
...
Simply describe what you want to change. For details, see the [Editing Tents](/working-with-tents/editing-tents) guide.
