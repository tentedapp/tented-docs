...
Templates live under **Tents > Templates**.
...
When you create a tent (**Tents > Add > Create Tent**, or **+ Add** from anywhere), the **Template** dropdown lists your approved templates. Pick one and your new tent starts from that design — then customize it with chat, leaving the template untouched.

![A screenshot of the Create Tent dialog with a template dropdown showing No template and Event Registration Template.](../images/tent-create-from-template.png)
