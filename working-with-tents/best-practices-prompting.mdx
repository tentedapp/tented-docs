...
You can clone a tent to create variations of your landing page for A/B testing. After cloning a tent, modify it with a new prompt to see which version performs better.
