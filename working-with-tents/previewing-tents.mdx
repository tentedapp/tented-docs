...
Fill out your forms with test data to check their layout and field validation for fields like email and phone numbers. Make sure to click through all links and buttons on the page.

<Note>
  Form submissions are disabled in the preview. Clicking a form's submit button won't send or store anything. To test a real submission end to end, publish the tent and submit the form on your live page.
</Note>

You should also test smooth scrolling to sections and verify anchor links work properly. Check external link behavior to confirm they open in a new tab if necessary.
