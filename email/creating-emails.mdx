...
- A **"View in browser" link** is one token away: point any link at `{{tented.viewAsWebpageLink}}` and each recipient gets a personal link to a hosted copy of their exact email, live for 6 months after the send. (Details: [The view-as-webpage link](/email/personalization#the-view-as-webpage-link).)
