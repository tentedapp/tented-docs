...
You'll land in the email editor: chat on the left, live preview on the right, with your default from name and address already filled in from [email settings](/configuring-tented/email-setup).
...
- The `{}` button inserts **personalization tokens** like `{{first_name}}` — they work in the subject, preheader, and anywhere in the body.
