...
<Note>
  Activating flows requires a **Pro or Max** plan. On the Free plan you can build, edit, and save flows — the canvas shows a reminder, and an **Upgrade to Unlock** gem appears in place of the Activate button. See [Upgrading Your Plan](/billing-subscriptions/upgrading-plan).
</Note>
