...
A sample is built to match a real send as closely as possible — same footer, same link handling, same rendering. If the email includes a [view-as-webpage link](/email/personalization#the-view-as-webpage-link), it works for real: the sample's link opens a hosted copy of that exact sample. The differences:
