...
- **[Sample sends](/email/sample-emails) get real links too.** A sample's view-as-webpage link opens a hosted copy of that exact sample — a handy way to share a test render — with the same 6-month lifetime.
