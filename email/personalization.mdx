...
- **Links stay live for 6 months.** After that, the page politely explains that the email is no longer available. The recipient's inbox copy is unaffected.
...
- **In sample sends the link is inert** — it opens a page explaining that web copies aren't created for samples. See [How a sample differs from a real send](/email/sample-emails#how-a-sample-differs-from-a-real-send).
