...
| Field | Type | Required | Notes |
| --- | --- | --- | --- |
| `input_data` | `object` | No* | Structured personalization data for this tent |
...
*\*Each item must include at least one of `input_data` or `instructions`. Both can be provided together.*
