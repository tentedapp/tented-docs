...
description: "Create a tent generation job through the public API, with optional branding, assets, and auto-publish."
---
...
- Use `/` or `__index__` to publish at the domain root
