---
title: "Tented API Overview"
description: "Create, edit, publish, measure, and delete tents, plus manage contacts, through Tented's public API."
---
...
<Card
  ...
  icon="terminal"
  href="/api-reference/tents/create-a-tent"
>
  Every endpoint across tents, analytics, contacts, emails, blasts, and triggered flows, with live request and response schemas.
</Card>
