...
description: "Authenticate to the Tented public API with workspace-scoped bearer API keys."
---

## How Authentication Works

The Tented public API uses bearer API keys. Each key belongs to exactly one Tented workspace, and every request runs in that workspace's context.
...
Public API keys are created inside Tented by a workspace admin.
